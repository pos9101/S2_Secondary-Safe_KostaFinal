 ...
 * Generated at: 2017-06-16 01:30:07 UTC
...
public final class admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/lib/spring-security-taglibs-3.1.0.RELEASE.jar", Long.valueOf(1496881799771L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("<head>\r\n");
      out.write("<title>Managerpage</title>\r\n");
      ...
      out.write("\t\t\t\t\tstr = str.concat(\"</td>\");\r\n");
      out.write("\t\t\t\t\tstr = str.concat(\"<td>\");\r\n");
      out.write("\t\t\t\t\tstr = str.concat(\"<form action='/web/webUpdate.in' method='post'>\");\r\n");
      out.write("\t\t\t\t\tstr = str.concat(\"<input type='hidden' name='serialnum' value=\"+temp[i].serialnum+\">\");\r\n");
      out.write("\t\t\t\t\tif(temp[i].status == \"occured\"){\r\n");
      out.write("\t\t\t\t\t\tstr = str.concat(\"<input type='hidden' name='status' value=\"+\"processing\"+\">\");\r\n");
      out.write("\t\t\t\t\t}else if(temp[i].status == \"processing\"){\r\n");
      out.write("\t\t\t\t\t\tstr = str.concat(\"<input type='hidden' name='status' value=\"+\"solved\"+\">\");\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\tstr = str.concat(\"<input type='hidden' name='status' value=\"+\"occured\"+\">\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tif(temp[i].status == \"occured\"){\r\n");
      out.write("\t\t\t\t\tstr = str.concat(\"<input type='submit' value=\"+\"processing\"+\">\");\r\n");
      out.write("\t\t\t\t\t}else if(temp[i].status == \"processing\"){\r\n");
      out.write("\t\t\t\t\tstr = str.concat(\"<input type='submit' value=\"+\"solved\"+\">\");\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tstr = str.concat(\"<input type='submit' value=\"+\"occured\"+\">\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("<tr><td>serialnum</td><td>latitude</td><td>longitude</td><td>time</td><td>status</td></tr>\r\n");
      out.write("</table>\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/user/admin.jsp(10,45) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthentication_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/user/admin.jsp(76,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/user/admin.jsp(77,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/user/admin.jsp(78,12) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
