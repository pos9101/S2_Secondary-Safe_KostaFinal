...
function init() {
	...
	var myLatLng = new google.maps.LatLng(37.402991, 127.108166);
	...
	$.getJSON('http://localhost:8090/web/json/datas', function(data) {
		...
		// position : new google.maps.LatLng(data.totalAccidents[0].latitude,
		// data.totalAccidents[0].longitude),
		// map : map,
		// // icon: 'resources/bootstrap3.3.5/img/icons/map-marker.png',
		// });
		// var marker2 = new google.maps.Marker({
		// position : new google.maps.LatLng(37.602991, 127.008166),
		// map : map,
		// // icon: 'resources/bootstrap3.3.5/img/icons/map-marker.png',
		// });
